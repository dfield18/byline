...
import { toOverviewData } from "@/components/dashboard-v2/adapt";
import { OverviewClient } from "./OverviewClient";
import { RefreshButton } from "../refresh-button";

/**
 * dashboard_v2 — an independent copy of the prop-driven OverviewDashboard
 * (the /overview-v2 view), with its OWN component + adapter under
 * components/dashboard-v2/ so this spoke can be iterated on without affecting
 * /overview-v2. Reachable at /subjects/[id]/dashboard_v2 and from the sidebar.
 *
